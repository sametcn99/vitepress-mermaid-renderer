  ...
  <div>
    ...
    <div class="mobile-controls controls visible-controls" ref="mobileControls">
      ...
      <div class="mobile-nav-buttons">
        <button @click="$emit('panUp')" title="Pan Up">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
        ...
        <button @click="$emit('panDown')" title="Pan Down">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
        ...
        <button @click="$emit('panLeft')" title="Pan Left">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
        ...
        <button @click="$emit('panRight')" title="Pan Right">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
